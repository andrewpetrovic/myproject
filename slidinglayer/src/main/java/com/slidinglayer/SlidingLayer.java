...
public class SlidingLayer extends FrameLayout {
    ...
    public SlidingLayer(Context context, AttributeSet attrs, int defStyle) {
        ...
        int shadowRes = ta.getResourceId(R.styleable.SlidingLayer_slidingshadowDrawable, -1);
        if (shadowRes != -1) {
    ...
    /**
     * Sets the listener to be invoked after a switch change {@link com.slidinglayer.SlidingLayer.OnInteractListener}.
     * 
     * @param listener
     *            Listener to set
     */
