...
public class CollectionView extends ListView {
    ...
    public RowComputeResult getmRowComputeResult(){
        return mRowComputeResult;
    }
...
//            view = mCallbacks.newCollectionItemView(getContext(), rowInfo.groupId, parent);
            view = mCallbacks.newCollectionItemView(getContext(),rowInfo.groupId,rowInfo.group.getDataIndex(indexInGroup),parent);
        }
    ...
    public static class Inventory {
        ...
        public ArrayList<InventoryGroup> getGroups(){
            return mGroups;
        }
    }
