...
public class NotificationClickReceiver extends BroadcastReceiver implements ISubject {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        msg.setNotificationClickActionType(intent.getIntExtra(MessageReceiver.KEY_NOTIFICATION_CLICK_ACTION_TYPE,7));
        msg.setNotificationActionType(intent.getIntExtra(MessageReceiver.KEY_NOTIFICATION_ACTION_TYPE, 5));
        msg.setNotificationActivity(intent.getStringExtra(MessageReceiver.KEY_NOTIFICATION_ACTIVITY));
        msg.setMessageType(ObserverMessage.BROADCAST_NOTIFICATION_CLICK);
        notifyObservers(msg);
    }
